/**
 * F202RFixV2Page.tsx
 * Full-screen standalone test page for the IGE_F202_R_FIXV2 double window with movable post (Iglo Edge series).
 * Route: /f202rfixv2
 *
...
export const F202RFixV2Page: React.FC = () => {
    ...
    <div className="fixed inset-0 flex overflow-hidden" style={{ background: '#0a0a14' }}>
      ...
      <div className="relative flex-1">
        ...
        >
          ...
          IGE_F202_R_FIXV2 — Iglo Edge Right Sash Test
        </div>
        ...
        >
          ...
          <div className="mt-1 text-white/40 border-t border-white/5 pt-1">
            Click hotspot to toggle right sash open/close
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 'auto', paddingTop: 12, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="text-[9px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.2)' }}>
            IGE_F202_R_FIXV2 Single Sash<br />
            Right sash with V8 movable post, no handle.<br />
            PST_EXT −48mm top+bot · PST_INT −75mm top+bot.<br />
            Sash overlap = 108mm.
          </div>
        </div>
      </div>
