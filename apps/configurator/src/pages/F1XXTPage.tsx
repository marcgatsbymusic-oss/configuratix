/**
 * F1XXTPage.tsx
 * Standalone page for testing/previewing the F1XXT fixed window viewer.
 * Route: /f1xxt
 */

import React, { useState } from 'react';
import { F1XXTViewer } from '../components/configurator/F1XXTViewer';

export const F1XXTPage: React.FC = () => {
    ...
    <div className="fixed inset-0 flex bg-[#0e0e1a] overflow-hidden">
      ...
      >
        <div>
          ...
          <div className="text-xs text-white/40 mt-0.5">F1XXT — Fixed Window</div>
        </div>
        ...
        <div style={{ marginTop: 'auto', paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="text-[9px] text-white/25 leading-relaxed">
            Profile geometry sourced from<br />IGLO5_FIX.step · 8 bodies extracted
          </div>
        </div>
      </div>
    </div>
