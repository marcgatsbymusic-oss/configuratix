/**
 * F202LPage.tsx
 * Full-screen standalone test page for the IGE_F202L double window with movable post (Iglo Edge series).
 * Route: /f202l
 */
...
export const F202LPage: React.FC = () => {
    ...
    <div className="fixed inset-0 flex overflow-hidden" style={{ background: '#0a0a14' }}>
      ...
      <div className="relative flex-1">
        ...
        >
          ...
          IGE_F202L — Iglo Edge Double Sash Test
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Left sash — turn only (inactive, no handle)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-[#eab676]" />
            <span>Right sash — open &amp; tilt (active, 1 handle)</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      >
        ...
        <div style={{ marginTop: 'auto', paddingTop: 12, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="text-[9px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.2)' }}>
            IGE_F202L Double Sash<br />
            1 handle, movable post.<br />
            Sash overlap = 108mm.
          </div>
        </div>
      </div>
