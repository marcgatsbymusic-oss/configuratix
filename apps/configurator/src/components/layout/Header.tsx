      ...
      <div className="border-b border-mammut-border">
        <div className="max-w-7xl mx-auto px-6 flex justify-end gap-6 py-1.5">
          <a
            ...
            className="text-[10px] uppercase tracking-widest text-mammut-grey-light hover:text-mammut-gold transition-colors duration-200 font-bold flex items-center gap-1"
          >
            <Globe size={10} />
            e-portal
          </a>
