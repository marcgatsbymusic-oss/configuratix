...
const TABLES = [
  ...
  {
    name: 'FARBEN',
    columns: ['FARBE', 'BEZEICHNUNG', 'FARBKLASSE', 'FARBKLASSE2', 'FARBKLASSE3', 'AUSSENFARBE', 'INNENFARBE', 'HERSTELLERSYSTEM', 'PRODUKTTYP'],
    sqliteDecl: `FARBE TEXT, BEZEICHNUNG TEXT, FARBKLASSE TEXT, FARBKLASSE2 TEXT, FARBKLASSE3 TEXT, AUSSENFARBE TEXT, INNENFARBE TEXT, HERSTELLERSYSTEM TEXT, PRODUKTTYP TEXT`,
    indexes: ['CREATE INDEX IF NOT EXISTS IX_FARBEN ON FARBEN(FARBE, HERSTELLERSYSTEM)'],
    query: `SELECT PHASEA_COLS FROM FARBEN`,
  },
  {
    name: 'FARBKL',
    columns: ['FARBKLASSE', 'BEZEICHNUNG'],
    sqliteDecl: `FARBKLASSE TEXT PRIMARY KEY, BEZEICHNUNG TEXT`,
    indexes: ['CREATE INDEX IF NOT EXISTS IX_FARBKL ON FARBKL(FARBKLASSE)'],
    query: `SELECT PHASEA_COLS FROM FARBKL`,
  },
  {
    name: 'FARBKOMBI',
    columns: ['FARBE', 'FARBCODEGRUPPE', 'FARBCODEAUSSEN', 'FARBCODEINNEN', 'BEZEICHNUNG', 'HERSTELLERSYSTEM'],
    sqliteDecl: `FARBE TEXT, FARBCODEGRUPPE TEXT, FARBCODEAUSSEN TEXT, FARBCODEINNEN TEXT, BEZEICHNUNG TEXT, HERSTELLERSYSTEM TEXT`,
    indexes: ['CREATE INDEX IF NOT EXISTS IX_FARBKOMBI ON FARBKOMBI(FARBE, HERSTELLERSYSTEM)'],
    query: `SELECT PHASEA_COLS FROM FARBKOMBI`,
  },
  {
    name: 'FARBCODES',
    columns: ['FARBCODETYP', 'FARBCODE', 'FARBKLASSE', 'FARBKLASSE2', 'FARBKLASSE3', 'HERSTELLERSYSTEM'],
    sqliteDecl: `FARBCODETYP TEXT, FARBCODE TEXT, FARBKLASSE TEXT, FARBKLASSE2 TEXT, FARBKLASSE3 TEXT, HERSTELLERSYSTEM TEXT`,
    indexes: ['CREATE INDEX IF NOT EXISTS IX_FARBCODES ON FARBCODES(FARBCODETYP, FARBCODE)'],
    query: `SELECT PHASEA_COLS FROM FARBCODES`,
  },
  {
    name: 'FELDFUEL',
    columns: ['ARTNR', 'ARTIKELTEXT1', 'EINBAUSTAERKE', 'SCHEIBENANZAHL', 'GLASSTAERKE1', 'GLASSTAERKE2', 'GLASSTAERKE3', 'SCHEIBENZWRAUM1', 'SCHEIBENZWRAUM2', 'FUELLUNGSTYP', 'GEWICHT', 'ARTIKELID'],
    sqliteDecl: `ARTNR TEXT, ARTIKELTEXT1 TEXT, EINBAUSTAERKE REAL, SCHEIBENANZAHL TEXT, GLASSTAERKE1 REAL, GLASSTAERKE2 REAL, GLASSTAERKE3 REAL, SCHEIBENZWRAUM1 REAL, SCHEIBENZWRAUM2 REAL, FUELLUNGSTYP TEXT, GEWICHT REAL, ARTIKELID REAL PRIMARY KEY`,
    indexes: ['CREATE INDEX IF NOT EXISTS IX_FELDFUEL_ARTNR ON FELDFUEL(ARTNR)'],
    query: `SELECT PHASEA_COLS FROM FELDFUEL`,
  },
];
