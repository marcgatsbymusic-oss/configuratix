...
def main():
    ...
    # Process only złożenie 07
    target = None
    for b in doc.blocks:
        if b.name.lower().strip() == 'złożenie 07':
            target = b
            break
    ...
    if target:
        ...
        print("Could not find złożenie 07 block!")
    
    out_doc.saveas('scratch/temp_zlozenie_07.dxf')
    print("Exported scratch/temp_zlozenie_07.dxf")
