...
def main():
    ...
    # Process only złożenie 02
    target = None
    for b in doc.blocks:
        if b.name.lower().strip() == 'złożenie 02':
            target = b
            break
    ...
    if target:
        ...
        print("Could not find złożenie 02 block!")
    
    out_doc.saveas('scratch/temp_zlozenie_02.dxf')
    print("Exported scratch/temp_zlozenie_02.dxf")
