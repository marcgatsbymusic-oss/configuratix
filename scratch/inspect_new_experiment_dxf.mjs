...
const dxfPath = 'C:\\Users\\Shadow\\Cloud-Drive\\Web dev Drutex Product Content\\CAD Files Drutex\\DWG_TO_DXF_PIPELINE\\Monday 8th experiment\\Library 3D Processed DXF\\IGLO 5\\2_IGLO 5 FRAME_AND_ SASH_FUSION PROCESSED.dxf';
try {
  ...
  // Trace layers across all entities recursively including inside blocks
  const allLayers = {};
