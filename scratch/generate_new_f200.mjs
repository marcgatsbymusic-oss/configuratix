...
const outputJsonPath = 'src/data/profiles/IGLO5/IG5_F200.json';

// --- DXF Processing Functions ---
function dist(a, b) {
...
try {
  ...
  // Find the two main contours by width
  ...
  // Contour 0 -> PST_INT (wide one: width ~84mm)
  // Contour 6 -> PST_EXT (narrow one: width ~44mm)
  // Let's grab them from sorted (sorted[0] and sorted[1] are the widest)
