  ...
  return (
    <main className="min-h-screen bg-black pt-28 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-16">
        <p className="text-[#eab676] text-xs uppercase tracking-[0.2em] font-semibold mb-3">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          {CATEGORIES.map((cat) => (
            <div key={cat.id} className="bg-[#1a1a1b] p-8 border border-[#2a2a2b] hover:border-[#eab676]/50 transition-colors">
              <h3 className="text-xl font-black uppercase mb-2 text-[#eab676]">{cat.name}</h3>
            ...
            >
              ...
              <div className="aspect-[4/3] bg-[#111112] relative overflow-hidden flex items-center justify-center p-8">
                {p.images && p.images[0] ? (
                  ...
                  <div className="w-full h-full border border-white/5 group-hover:border-[#eab676]/20 transition-colors duration-500">
