/**
 * F2MPXPage.tsx
 * Full-screen standalone test page for the F2MPX double window with movable post.
 * Route: /f2mpx
 */
...
const SCENERIES = [
  { label: 'Dark',       value: 'studio-dark' },
  { label: 'Studio',     value: 'studio-grey' },
  { label: 'Garden',     value: 'modern-minimalist' },
  { label: 'Forest',     value: 'warm-nordic' },
  { label: 'Urban',      value: 'urban-skyline' },
  { label: 'Coastal',    value: 'coastal-mediterranean' },
];
  ...
  return (
    <div className="fixed inset-0 flex overflow-hidden" style={{ background: '#0a0a14' }}>
      ...
      <div className="relative flex-1">
        ...
        {/* Sash legend */}
        <div
          className="absolute bottom-4 left-4 flex flex-col gap-1 px-3 py-2 rounded-xl text-[10px]"
          style={{
