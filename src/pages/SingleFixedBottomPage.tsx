...
import { SingleFixedBottomProfileInspector } from '../components/configurator/SingleFixedBottomProfileInspector';
import { ArrowLeft } from 'lucide-react';

export const SingleFixedBottomPage: React.FC = () => {
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold text-white/50 uppercase tracking-wider">
              IGLO 5 Single Fixed Bottom Inspector
            </span>
          </div>
        </div>

        <div className="text-[9px] font-black uppercase tracking-wider text-white/25">
          Solid Block Renderer v1.0
        </div>
      </div>

      {/* Main Content */}
      <div className="flex-grow relative overflow-hidden">
        <SingleFixedBottomProfileInspector />
      </div>
    </div>
  );
};
