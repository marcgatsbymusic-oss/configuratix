/**
 * F202Lv2Page.tsx
 * Full-screen standalone test page for the IGE_F202Lv2 double window with movable post (Iglo Edge series).
 * Route: /f202lv2
 */
...
export const F202Lv2Page: React.FC = () => {
  const [width,    setWidth]    = useState(1200); // Default 1200mm wide
  const [height,   setHeight]   = useState(1200); // Default 1200mm tall
    ...
    <div className="fixed inset-0 flex overflow-hidden" style={{ background: '#0a0a14' }}>
      ...
      <div className="relative flex-1">
        ...
        >
          ...
          IGE_F202Lv2 — Iglo Edge Double Sash Test
        </div>
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Left sash — open &amp; tilt (active, 1 handle)</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-zinc-500" />
            <span>Right sash — turn only (inactive, no handle)</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="mt-1 text-white/40 border-t border-white/5 pt-1">
            Click markers on window stiles to animate sashes
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div style={{ marginTop: 'auto', paddingTop: 12, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="text-[9px] leading-relaxed" style={{ color: 'rgba(255,255,255,0.2)' }}>
            IGE_F202Lv2 Double Sash<br />
            1 handle (left active), movable post.<br />
            Sash overlap = 108mm.
          </div>
        </div>
      </div>
