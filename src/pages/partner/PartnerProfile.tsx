...
export function PartnerProfile() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h2 className="text-3xl font-bold tracking-tight text-white">{t('partner.profile.title')}</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-[#111] border border-gray-800 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-white mb-4">{t('partner.profile.cobranding')}</h3>
            ...
            <div className="border-2 border-dashed border-gray-800 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:bg-gray-800/20 transition-colors cursor-pointer group">
              ...
              <span className="font-medium text-white mb-1">{t('partner.profile.clickToUpload')}</span>
