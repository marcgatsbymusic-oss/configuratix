...
export const F104ProfileInspector: React.FC = () => {
      ...
      <div className="w-[380px] bg-[#0c0d18] border-l border-white/5 flex flex-col z-10 shrink-0 text-white overflow-y-auto">
        ...
        <div className="p-5 border-b border-white/5 bg-[#0e101f]">
          ...
          <h2 className="text-lg font-black text-white uppercase tracking-tight flex items-center gap-2">
            1600-IGLO EDGE <span className="bg-white/5 border border-white/10 text-white/50 text-[10px] px-1.5 py-0.5 rounded uppercase font-bold">F104</span>
          </h2>
