...
doc = ezdxf.readfile("/mnt/user-data/uploads/IGLO5_entire_profile_sections.dxf")
OUT = "/home/claude/out"; os.makedirs(OUT+"/profiles", exist_ok=True)
...
for blk in doc.blocks:
    ...
    json.dump(rec, open(f"{OUT}/profiles/{c}__{safe}.json","w"), ensure_ascii=False)
...
json.dump(recipes, open(f"{OUT}/zlozenie_recipes.json","w"), ensure_ascii=False, indent=1)
